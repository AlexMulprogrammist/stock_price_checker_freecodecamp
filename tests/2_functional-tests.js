...
suite('Functional Tests', function() {
    suite("5 functional get request test", function() {
        ...
        test("Viewing two stocks and liking them: GET request to /api/stock-prices/", function(done) {
            chai
                ...
                .end(function(err, res) {
                    ...
                    assert.exists(res.body.stockData[0].price, "AMZN has a price")
                    assert.exists(res.body.stockData[1].price, "T has a price")
                    assert.exists(res.body.stockData[0].rel_likes, "has a rel_likes")
                    assert.exists(res.body.stockData[1].rel_likes, "has a rel_likes")
                    done()
                })
        })
    })
